	       ...
	       var formData = new FormData($("#imageuploaduniques")[0]);
			...
			$.ajax({   
				...
				//alert(data)
					...
					//   alert();
						$(".kv-file-remove").fadeOut().html(data).fadeIn('slow');
					 return false;
					}
...
<?php  $this->session->unset_userdata('registrationsucess'); } ?>
          ...
          <label>Upload  Multiple Property Images (upto 8 images)</label>
...
<input type="hidden" id="defaultamenities1" name="amenities1" value="<?php echo $viewdata[0]->amenities; ?>" />
	  ...
	  <div class="col-md-6">
		...
		<div class="form-group">
			  <label>Property Price <input type="checkbox" id="negotiable" name="negotiable[]" value="Negotiable"> Negotiable</label>
		...
		<div class="form-group" style="display:none" id="roomsdivs">
			...
			<div class="form-group">
			 ...
			 <textarea type="text" class="form-control" id="address_details" onchange="address_detailsr()" name="address_details"></textarea>
