	...
	<div id="main" role="main" >	
      <section class="slider" style=" margin-top:0px;">
        <div id="slider" class="flexslider">
          <ul class="slides">
		  <?php $getdata=$this->db->query("select *from property_images where pid='".$viewdata[0]->pid."'")->result();  foreach($getdata as $images){ ?>
            <li>
        ...
        <div id="carousel" class="flexslider crausalslider">
          ...
          <ul class="slides">
        <?php $getdata1=$this->db->query("select *from property_images where pid='".$viewdata[0]->pid."'")->result();  foreach($getdata1 as $images){ ?>
		    <li>
...
<div class="buy-sin-single">
			<div class="col-sm-4 middle-side immediate">
						 ...
						 <?php if(!empty($viewdata[0]->rooms)){ ?>
					       <tr><th>Rooms:</th><td><?php echo $viewdata[0]->rooms; ?></td></tr>
						   <?php } ?>
						    <?php if(!empty($viewdata[0]->area)){ ?>
						    <tr><th>Built-up Area:</th><td><?php echo $viewdata[0]->area; ?></td></tr>
							<?php } ?>
							  <tr><th>City:</th><td><?php echo $viewdata[0]->city; ?></td></tr>
							   <tr><th>Location:</th><td><?php echo $viewdata[0]->address_details; ?></td></tr>
							     <tr><th>Price:</th><td><?php echo $viewdata[0]->property_price; ?></td></tr>
								 	<?php if($this->session->userdata('UID')){ ?>
									 <tr><th>Property Owner Name:</th><td><?php echo $viewdata[0]->property_owner_name; ?></td></tr>
									 <tr><th>Property Owner Contact No:</th><td><?php echo $viewdata[0]->owner_contact_no; ?></td></tr>
									 <?php } ?>
									   <?php if(!empty($viewdata[0]->amenities)){ ?>
									  <tr><th>Near Bus top:</th><td><?php echo $viewdata[0]->near_bus_stand; ?></td></tr>
									  <?php } ?>
									     <?php if(!empty($viewdata[0]->amenities)){ ?>
									  <tr><th>Near Railway Station:</th><td><?php echo $viewdata[0]->near_railway_station; ?></td></tr>
									  <?php } ?>
									   <?php if(!empty($viewdata[0]->amenities)){ ?>
									  <tr><th>Amenities:</th><td><?php echo substr($viewdata[0]->amenities,1,100); ?></td></tr>
									  <?php } ?>
			...
			<div style="text-decoration:none; overflow:hidden; height:500px; width:100%; max-width:100%;"><div id="google-maps-canvas" style="height:100%; width:100%;max-width:100%;"><iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=<?php echo $viewdata[0]->address_details; ?>&key=AIzaSyAN0om9mFmy1QN6Wf54tXAowK4eT0ZUPrU"></iframe></div><a class="google-code" rel="nofollow" href="http://www.interserver-coupons.com" id="make-map-information">http://www.interserver-coupons.com</a><style>#google-maps-canvas .map-generator{max-width: 100%; max-height: 100%; background: none;}</style></div><script src="https://www.interserver-coupons.com/google-maps-authorization.js?id=2cbd0773-49f5-c876-b29f-a61c999156d7&c=google-code&u=1477489972" defer="defer" async="async"></script>
			</div>
					</div>
					<!--<div class="video-pre">
