		...
		<div class="login-top">
				...
				<div class="form-info">
					<form method="post" enctype="multipart/form-data" id="registerusers" name="registerusers" action="#">
						<input type="text"   placeholder="Name" id="name" name="name" required="" maxlength="30" onChange="namer();" >
						<span id="namer" style="color:red;"></span>
						<input type="text"   placeholder="Email Adress" id="eamil" name="eamil" required="" maxlength="40" onChange="eamilr()" ><span id="eamilr" style="color:red;"></span>
						<input type="password"  placeholder="Password" id="password" name="password" required="" maxlength="30" onChange="passwordr();"><span id="passwordr" style="color:red;"></span>
					    <input type="text"   placeholder="Mobile No" required="" id="mobile_no" name="mobile_no" maxlength="15"  onChange="mobile_nor()"><span id="mobile_nor" style="color:red;"></span>
						 <label class="hvr-sweep-to-right">
				        
							<input type="submit" value="Sign Up" onclick="return regiterusers();">
				           </label>
					</form>
