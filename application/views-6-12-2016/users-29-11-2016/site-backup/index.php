...
<br />
  ...
  <strong>Note!</strong> Not Found Property
</div>
					<?php } ?>
   ...
   <?php }else { ?>
    <?php  $property=$this->db->query("SELECT * FROM property_post p inner join property_images pc on p.pid=pc.pid where p.status='active' group by p.pid desc")->result(); 
