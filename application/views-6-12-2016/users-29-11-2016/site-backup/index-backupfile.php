...
var namecheck = /[A-Za-z]+$/;
	...
	<div class="project">
		...
		<div class="sap_tabs">	
				     <div id="horizontalTab12" style="display: block; width: 100%; margin: 0px;">
						  <ul class="resp-tabs-list">
							  ...
							  <li class="resp-tab-item <?php if(isset($_GET['allbuy'])) { echo 'resp-tab-active';  }else { echo ''; } ?>" aria-controls="tab_item3-1" role="tab"><span>For Buy</span></li>
							  <li class="resp-tab-item <?php if(isset($_GET['allrent'])) { echo 'resp-tab-active';  }else { echo ''; } ?>" aria-controls="tab_item4-2" role="tab"><span>For Rent</span></li>
							  <li class="resp-tab-item <?php if(isset($_GET['allresale'])) { echo 'resp-tab-active';  }else { echo ''; } ?>" aria-controls="tab_item5-3" role="tab"><span>For Sale</span></li>
							  <div class="clearfix"></div>
						  </ul>				  	 
						  <div class="resp-tabs-container">
						  		<h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item3-1"><span class="resp-arrow"></span>All Homes</h2><div class="tab-1 resp-tab-content resp-tab-content-active" aria-labelledby="tab_item3-1" style="display:block">
								 	<div class="facts">
							     ...
							     <h2 class="resp-accordion" role="tab" aria-controls="tab_item3-1"><span class="resp-arrow"></span>For Buy</h2><div class="tab-1 resp-tab-content" aria-labelledby="tab_item3-1">
									<div class="facts">		
										<label style="color:white;">Enter Location</label>							
										<div class="login">
										<form method="post" enctype="multipart/form-data" id="searchformsalehome" name="searchformsalehome">
											<input type="text"  placeholder="Enter Location" id="forsalehome" name="forsalehome">		
									 		<input type="submit" value="" onclick="return searchbysale1();">
											</form>
									 	</div>
											<span id="forsaler1" style="color:red;"></span>     
							        </div>	
		...
		<div class="col-md-4"><a class="btn btn-success" href="<?php echo site_url(); ?>"> <i class="fa fa-key fa-5x" aria-hidden="true"></i><br />
		Onwer Property

</a>&nbsp;
		<a class="btn btn-success" href="<?php echo site_url(); ?>?builder-property=Builder"><i class="fa fa-building fa-5x" aria-hidden="true"></i>
		<br />
...
<br />
   ...
   <?php foreach( $property as  $movie ) { ?>
					...
					<?php  }else if(isset($_GET['allhome'])) { 
					 $city=$_GET['location']; 
		  $property=$this->db->query("SELECT * FROM property_post p inner join property_images pc on p.pid=pc.pid where  p.address_details LIKE '%$city%' and status='active' group by p.pid desc")->result(); ?>
   <div class="row">
   <?php foreach( $property as  $movie ) { ?>
					<div class="col-md-4 project-grid">
						<div class="project-grid-top">
   ...
   <?php }else { ?>
    <?php  $property=$this->db->query("SELECT * FROM property_post p inner join property_images pc on p.pid=pc.pid where p.property_builder='Owner' and p.status='active' group by p.pid desc")->result(); 
