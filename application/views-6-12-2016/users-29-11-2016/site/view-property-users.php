...
Your Property Updated Successfully..
</div> 
...
<?php  $this->session->unset_userdata('registrationsucess'); } ?>
	<!--	<h3>Your posted property List</h3>-->
		<div class="box-sin">
		    ...
		    $MOVIES1=$this->db->query("SELECT * FROM property_post where uid='$id' and status='active' order by pid desc LIMIT $start_from, $num_rec_per_page")->result();
				...
				<div class="box-col" style="box-shadow: 0 2px 5px 0 rgba(0,0,0,.16),0 2px 10px 0 rgba(0,0,0,.12);">
					 ...
					 <div class="col-md-4 col-sm-6 col-xs-4">
					  <a  href="<?php echo site_url(); ?>update_your_property/<?php echo $movie->pid;  ?>" class="hvr-sweep-to-right more" >Update Property</a>
					   ...
					   <div class="col-md-4 col-sm-6 col-xs-4">
					 <a class="hvr-sweep-to-right more" href="<?php echo site_url();?>Users_Controller/delete_our_owen_property/<?php echo $movie->pid; ?>"  onClick="return confirm('Are You Sure Delete This Property Property');">Delete Property</a>
					 </div>
					  </div>
					  <br />
					</div>				
