...
$(document).ready(function(){
  ...
  <div class="row">
	...
	<input type="submit" class="btn btn-danger" name="bulk_delete_submit1"  onclick="return deleteConfirm();" value="Delete" />&nbsp;&nbsp;<input type="submit" value="active" name="bulk_active_submit1" class="btn btn-success" onclick="return updatestatus();" />&nbsp;&nbsp;<input type="submit" value="inactive" onclick="return updatestatus();" class="btn btn-danger" name="bulk_inactive_submit1" /></th></tr></thead>
	<tbody>
	<?php $i=1; 
	...
	<tr>
	<td><span><?php echo $i++; ?>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $rows->prid; ?>"/></span></td>
