...
<td><a href="<?php echo site_url();?>view-main-property-category?action=newsupdat&propertyid=<?php echo  $rows->scid;?>"  title="Edit" class="btn btn-primary"><i class="fa fa-edit"></i></a>&nbsp;
		 <?php if($rows->status=='active') { ?><a href="<?php echo site_url();?>Admin_Controller/updatestatus_main_property_category_inactive/<?php echo  $rows->scid; ?>" onclick="return confirm('Are You Sure Update This Status'); " class="btn btn-success"><?php echo $rows->status;  ?></a><?php }else {?><a href="<?php echo site_url();?>Admin_Controller/updatestatus_main_property_category_active/<?php echo  $rows->scid; ?>"  onclick="return confirm('Are You Sure Update This Status'); " class="btn btn-danger"><?php echo $rows->status; }  ?></a>&nbsp;
		   <a href="<?php echo site_url(); ?>Admin_Controller/updatestatus_main_property_category_delete/<?php echo  $rows->scid;?>" class="btn btn-danger" onClick="return confirm('Are You Sure Delete This Main Property Category'); "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
		   </td>
	</tr>
	<?php } ?>
	</tbody>
