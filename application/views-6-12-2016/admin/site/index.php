                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <div class="row">
									...
									<?php $totalproperty=$this->db->query("select *from property_post")->result(); ?>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
									<?php $activecount=$this->db->query("select *from property_post where status='active'")->result(); ?>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
										<?php $inactive=$this->db->query("select *from property_post where status='inactive'")->result(); ?>
                                        <div class="huge"><?php echo count($inactive); ?></div>
                                        <div>Total Inactive Property</div>
                                    </div>
                                </div>
                            </div>
