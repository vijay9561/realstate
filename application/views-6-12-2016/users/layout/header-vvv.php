...
border: 0px;
	...
	<div class="container">
		...
		<div class="col-md-3">
			<div class="logo">
				<h1><a href="<?php echo site_url(); ?>">SAI BROKING<!--<img src="<?php echo base_url(); ?>assets/images/saibroking.gif" />--></a></h1>
...
<style>
.captioncontrol{
background: rgba(12, 117, 16, 0.5) none repeat scroll 0% 0%;padding:20px;position: absolute;top: 43%; width:75%; left:10%; right:15%;
}
...
<script>
function allsearchmaincategoryr(){ if($('#allsearchmaincategory').val()==''){}else{ $("#allsearchmaincategoryr").html(' '); } }
...
<div class="header-right">
		<div class=" banner">
		  ...
		  <?php } ?>
                     ...
                     <div class="input-group stylish-input-group">
					<input type="text" class="form-control"  placeholder="Keyword..." id="allsearchkeyword" name="allsearchkeyword" required>
                    <span class="input-group-addon">
