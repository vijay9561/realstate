...
<div class="header-right">
		<div class=" banner">
		  ...
		  <?php } ?>
						...
						$subcategory=$this->db->query("select *from property_category where  pcid='".$_GET['allsearchsubcatories']."'")->result();
						 ?>
							 <option value="<?php echo $_GET['allsearchsubcatories']; ?>"><?php echo $subcategory[0]->property_name; ?></option>
							 <?php }else{ ?>
