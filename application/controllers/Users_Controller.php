...
table {
    ...
    margin-left: -10px;
    margin-bottom: -10px;
    border-bottom-right-radius: 14px 0px 14px;
        ...
        <td class="container">
          <div class="content">
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Welcome To Saibroking,</p>
						
                       
						<hr style="border-bottom: 1px solid #581b56;">
						<p><strong>SAIBROKING Users,</strong></p>
                          ...
                          <tbody>
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                <tr><th style="width:20%">Users Name:</th><td>'.$name.'</td></tr>
		            <tr><th style="width:20%">Users Emaild Id</th><td>'.$email.'</td></tr>
					<tr><th style="width:20%">Users Phone</th><td>'.$phone.'</td></tr>
					<tr><th style="width:20%">Users Feedback</th><td>'.$message.'</td></tr>
                                  </tbody>
            ...
            <div class="footer">
              <table border="0" cellpadding="0" cellspacing="0">
			  <tr>
			   <td class="content-block" style="float:left;">
				 <span class="content-block">
				 <a href=""><img src="http://saibroking.com/assets/images/sai-broking-logo-2.png" style="height:40px;"></a></span>
				
				 </td>
				 <td style="float:left;margin-left: 20px;"> <span class="content-block">
				Mobile No: +91 8805 723 555
				 </span></td>
			  </tr>
			   <tr>
...
$formattedAddr = str_replace(' ','+',$address);
   ...
   $insert=array('property_title'=>$this->input->post('property_title'),'category_id'=>$this->input->post('category_id'),'property_price'=>$this->input->post('property_price'),'rooms'=>$this->input->post('rooms'),'area'=>$this->input->post('area'),'property_builder'=>$this->input->post('property_builder'),
			...
			$propertyid=$this->db->insert_id();
			 $currentusers=$this->db->query("select *from users where uid='".$userid1."'")->result();
		$msg='<!doctype html>
<html>
  <head>
    <meta name="viewport" content="width=device-width" />
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="body">
      <tr>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Dear '.$currentusers[0]->name.',</p>
						
                        <p>Your Ad Submitted Successfully.</p>
						<hr style="border-bottom: 1px solid #581b56;">
						<p><strong></strong></p>
                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                          <tbody>
        ...
        <td>&nbsp;</td>
						...
						$mail_subject2='Ad Submitted Successfully';
				    $mail_sent2 = mail($currentusers[0]->eamil,$mail_subject2,$msg,$headers2);
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p>Your Ad Submitted Successfully.</p>
						<hr style="border-bottom: 1px solid #581b56;"></hr>
						<p><strong></strong></p>
                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                          <tbody>
                            <tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Welcome To Saibroking,</p>
						<hr style="border-bottom: 1px solid #581b56;">
						<p><strong>Ad Post Requirement,</strong></p>
                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                          <tbody>
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                     <th>Users First Name:&nbsp;&nbsp;</th><td>'.$firstname.'</td>
                                    </tr>
									 <tr>
                                     <th>Users Last Name:&nbsp;&nbsp;</th><td>'.$lastname.'</td>
                                    </tr>
									<tr>
                                     <th>Users Email ID:&nbsp;&nbsp;</th><td>'.$eamil.'</td>
                                    </tr>
									<tr>
                                     <th>User Mobile No:&nbsp;&nbsp;</th><td>'.$mobile_no.'</td>
                                    </tr>
									<tr>
                                     <th>Users Professional:&nbsp;&nbsp;</th><td>'.$yourpropesinal.'</td>
                                    </tr>
									<tr>
                                     <th>Users Address Details:&nbsp;&nbsp;</th><td>'.$address.'</td>
                                    </tr>
									<tr>
                                     <th>Users Ad Budget:&nbsp;&nbsp;</th><td>'.$budget.'</td>
                                    </tr>
									<tr>
                                     <th>Users Ad Description:&nbsp;&nbsp;</th><td>'.$description.'</td>
                                    </tr>
									<tr>
                                     <th>Ad Category:&nbsp;&nbsp;</th><td>'.$categoryname[0]->category_name.'</td>
                                    </tr>
									<tr>
                                     <th>Ad Sub Category:&nbsp;&nbsp;</th><td>'.$sub_category_id.'</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="body">
      <tr>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p><strong>Dear &nbsp;'.$firstname.' ,<br></strong> thank you your requirement posted successfully.. we will give feedback as soon as possible,</p>
        ...
        <td>&nbsp;</td>
		  ...
		  $mail_to='info@saibroking.com';
		  $mail_subject1="Ad posted successfully - saibroking";
      ...
      <tr>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p><strong>Dear Admin ,<strong> <br> '.$firstname.' is interested in '.$unquie_id.' of '.$ownernames.'</p>
						<hr style="border-bottom: 1px solid #581b56;">
						<p><strong>Ad Users Insersted Details,</strong></p>
                        <table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                          <tbody>
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
									...
									<tr>
                                     <th>Mobile No:&nbsp;&nbsp;</th><td>'.$mobile_no.'</td>
                                    </tr>
									<tr>
                                     <th>Users Details:&nbsp;&nbsp;</th><td>'.$query_message.'</td>
                                    </tr>
									<tr>
                                     <th>Ad Category:&nbsp;&nbsp;</th><td>'.$categoryname[0]->category_name.'</td>
                                    </tr>
									<tr>
                                     <th>Users Ad For:&nbsp;&nbsp;</th><td>'.$salyeuser.'</td>
                                    </tr>
        ...
        <td>&nbsp;</td>
		 ...
		 // $mail_subject1="Property - saibroking";
		  $mail_subject='Users Ad View Contact';
		 $mail_sent = mail($mail_to,$mail_subject,$msg,$headers);
	/*	  $mail_sent1 = mail($eamil,$mail_subject1,$msg1,$headers1);*/
		 if($mail_sent==true){
...
$this->Users_Model->duplicateemails($emails);
}
}
