...
<?php  $this->session->unset_userdata('registrationsucess'); } ?>
          ...
          <div class="container kv-main" id="dataconvasss" style="width:100%">
			...
			<span id="imagesizevalidation" style="color:red;"></span>
	...
	<form role="form" method="post"  enctype="multipart/form-data" id="proppetpostedd">
			...
			<div class="form-group">
				...
				<?php $categories=$this->db->query("select *from main_category where mid=1")->result(); ?>
			<input type="text" class="form-control" id="property_category" value="<?php echo $categories[0]->category_name; ?>" data-popup-open="popup-1" name="myownproperty" />
				<input type="hidden" id="mainhiddencategory" name="mainhiddencategory" value="<?php echo $categories[0]->mid; ?>" />
...
<input type="hidden" id="defaultamenities1" name="amenities1" value="<?php echo $viewdata[0]->amenities; ?>" />
	  ...
	  <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="ckeditor" name="property_description" placeholder="add your property details here"  onchange="ckeditorr();" rows="10" maxlength="500" style="resize:none"></textarea>
