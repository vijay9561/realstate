      ...
      <form method="post" enctype="multipart/form-data" id="registerusers" name="registerusers" action="#">
        ...
        <div class="form-group">
          ...
          <span id="property_titler" style="color:red;"></span>
		    <label style="color: #6b7575;font-weight: unset;">Example: I have requirement for 1BHK flat in Garkheda area</label>
		  </div>
		  <div class="form-group">
        ...
        <!--<div class="form-group" style="display:none;" id="propertydives">
          ...
          <span id="slaebyr" style="color:red;"></span> </div>-->
		   ...
		   <select type="text" class="form-control" name="budget" id="budget">
		   <option value="">Select Budget</option>
		     <option value="Rs 0-2000">Rs 0-2000</option>
			   <option value="Rs 2000-5000">Rs 2000-5000</option>
		   <option value="Rs 5000-10000">Rs 5000-10000</option>
		   <option value="Rs 10000-20000">Rs 10000-20000</option>
		    <option value="Rs 20000-40000">Rs 20000-40000</option>
			 <option value="Rs 40000-80000">Rs 40000-80000</option>
