      ...
      <div class="map-single">
        <div style="text-decoration:none; overflow:hidden; height:300px; width:100%; max-width:100%;">
          <div id="google-maps-canvas" style="height:100%; width:100%;max-width:100%;">
            <iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=<?php echo $viewdata[0]->address_details; ?>+<?php echo $viewdata[0]->city; ?>&key=AIzaSyDLz3YAIDupBgMdSKkuhkBgNwvBjLmXwCA"></iframe><br>
      ...
      <div class="modal-body">
        ...
        <div style="display:none" id="forgootpasswordid">
          ...
          <form method="post" action="#" id="forgotpasswordemailsrr">
            ...
            &nbsp;&nbsp;<a  id="closewidows" onClick="closewidows();" style="cursor:pointer;" class="btn btn-default">Close</a>
          </form>
        </div>
      </div>
    </div>
