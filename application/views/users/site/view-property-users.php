		 ...
		 $images=$this->db->query("select *from property_images where pid='".$movie->pid."' order by piid asc limit 0,1")->result();
             ?>
				<div class="box-col" style="box-shadow: 0 2px 5px 0 rgba(0,0,0,.16),0 2px 10px 0 rgba(0,0,0,.12);">
					 ...
					 <?php if($movie->main_categories_id==1){ if(!empty($images[0]->image_name)) {?>
						...
						<?php }?>
						<?php if(empty($images[0]->image_name)) { ?>
			 <a href="<?php echo site_url(); ?>view_single_property_details/<?php echo $movie->pid; ?>" class="mask"><img src="<?php echo base_url(); ?>assets/images/bo2.jpg" class="img-responsive imgclassimages"  alt=""/></a> 
						<?php } ?>
						<?php }else{ if(!empty($images[0]->image_name)) {?>
						...
						<?php }?>
						<?php if(empty($images[0]->image_name)) { ?>
			 <a href="<?php echo site_url(); ?>view_other_details/<?php echo $movie->pid; ?>" class="mask"><img src="<?php echo base_url(); ?>assets/images/bo2.jpg" class="img-responsive imgclassimages"  alt=""/></a> 
						<?php } ?>
						<?php } ?>
							 <div class="row">
