<div class="container">
	...
	<!--	<h3>posted property</h3>-->
		<div class="box-sin">
		    ...
		    $MOVIES1=$this->db->query("SELECT * FROM property_post where  status='active' and main_categories_id='1' order by pid desc LIMIT $start_from, $num_rec_per_page")->result();
...
<?php };  ?>
 <?php if($total_records>19) { ?>
  <li class="page"><a href="<?php echo site_url(); ?>view-posted-property?page=<?php echo $next_page; ?>">Next Page</a></li>
  <?php } ?>
