...
<div class="container">
  <div class="buy-single-single">
    ...
    <div class="alert alert-success">ad owner contact view successfully.. </div>
	  ...
	  <table style="margin-top: -10px;">
		<?php if(!empty($viewdata[0]->property_unique_id)){ ?>
          <tr style="color: #5D635C;font-size: 11px;">
            <td>Ad ID:</td>
            <td>&nbsp;&nbsp;<?php echo $viewdata[0]->property_unique_id; ?>&nbsp;|&nbsp;Posted On&nbsp;<?php $yrdata= strtotime($viewdata[0]->date); echo date('d-M-Y', $yrdata); ?></td>
          </tr>
          <?php } ?></table>
	</div>
	</div>
...
<style>
internalsccssmy{cursor:pointer;margin-top: 10px;}
@media(max-width:768px){
.internalsccssmy{cursor: pointer;
margin-top: -37px;}
}
</style>
    ...
    <div class="buy-sin-single">
      <div class="col-sm-4 middle-side immediate" style="padding-left: 14px;">
       ...
       <!-- <div class="right-side">--> <a class="btn btn-primary mydbubttt internalsccssmy" data-toggle="modal" data-target=".bs-example-modal-sm">Contact</a> <!--</div>-->
        <?php } else { ?>
        ...
        <div class="#">
          <form method="post" enctype="multipart/form-data" id="withloginusers" name="withloginusers">
            ...
            <input type="submit"  value="Contact" class="btn btn-primary internalsccssmy mydbubttt"  onclick="return loginwithantoherusers();">
          </form>
        </div>
    ...
    <div style="border: 1px solid #27da93;border-radius: 20px 0px 20px;">
        ...
        <?php if(!empty($viewdata[0]->category_id)){ $queryproperty=$this->db->query("select category_name from subcategory where scid='".$viewdata[0]->category_id."'")->result(); 
      ...
      <?php if(!empty($viewdata[0]->car_driven_kilometer)){ ?>
          ...
          <tr>
            <th><?php if($viewdata[0]->main_categories_id==5) { ?>Tution Type<?php } else {  ?>Condtion<?php } ?>:</th>
      ...
      <div class="map-single">
        <div style="text-decoration:none; overflow:hidden; height:300px; width:100%; max-width:100%;">
          <div id="google-maps-canvas" style="height:100%; width:100%;max-width:100%;">
            <iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=<?php echo $viewdata[0]->address_details; ?>+<?php echo $viewdata[0]->city; ?>&key=AIzaSyDLz3YAIDupBgMdSKkuhkBgNwvBjLmXwCA"></iframe>
          </div>
...
.mydemossss{ /*or other element you want*/
	...
	<div class="col-md-4">
	<?php  $query123=$this->db->query("SELECT  adveristment_name,advertisment_image FROM advertisment where top_advertisement='Internal Page (Map Side)' and mid='".$viewdata[0]->main_categories_id."' ORDER BY RAND()")->result();
	//echo $this->db->last_query(); ?>
	<?php if(!empty($query123)) { ?>
	<div class="row mydemossss" style="border: 1px solid #AEAEAE; margin-top:5px;">
      ...
      <a href="<?php echo site_url(); ?>contact" ><img  src="../adminassets/upload/ad/<?php echo $row->advertisment_image; ?>" style="height:380px;width:100%"></a>
      </div>
	  <?php } ?>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="#" id="loginform123">
          ...
          &nbsp;&nbsp;<a id="openwindows" style="cursor:pointer;" onClick="openwidows();">Forgot Password?</a>
        </form>
        ...
        <div style="display:none" id="forgootpasswordid">
          ...
          <form method="post" action="#" id="forgotpasswordemailsrr">
            ...
            &nbsp;&nbsp;<a  id="closewidows" style="cursor:pointer;" class="btn btn-default" onClick="closewidows();">Close</a>
          </form>
        </div>
      </div>
    </div>
