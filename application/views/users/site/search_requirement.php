		 ...
		 $num_rec_per_page=18;
		   ...
		   $property=$this->db->query("SELECT * FROM post_requirement where status='active' order by prid desc LIMIT $start_from, $num_rec_per_page")->result();  $i=1; foreach( $property as  $movie ) { ?>
		           ...
		           <div class="panel panel-primary">
							...
							<tr style="color:#000;;font-size: 11px;">
						<td><strong>Property</strong><span style="font-weight: unset;">&nbsp;&nbsp;>></span></td>
						...
						<td><strong>Budget</strong></td>
							<td>&nbsp;&nbsp; <strong> <?php echo $movie->budget; ?></strong></td>
							</tr>       <?php } ?>
							
							<?php  if(!empty($movie->date)){ ?>
							<tr style="color:#000;;font-size: 11px;">
						<td><strong>Posted Date:</strong></td>
							<td>&nbsp;&nbsp; <strong> <?php $yrdata= strtotime($movie->date); echo date('d-M-Y', $yrdata); ?></strong></td>
							</tr>       <?php } ?>
						...
						<?php /*?>	<?php  if(!empty($movie->address)){ ?>
							...
							<?php /*?><?php if($this->session->userdata('UNIQUEID')==$movie->property_unique_id){ ?>
								<tr style="color:#000;">
							<th>Email:</th>
							...
							<br />		<!-- 	<small>50 Reviews</small>-->
								...
								<?php /*?> <p>Property For <?php echo $movie->slaeby; ?><?php */?>
								  ...
								  <p style="text-align: justify;"><strong>Requirement Details:</strong> <?php echo substr($movie->description,0,1000); ?>
								 </p><br />
								 <div class="row">
								 <div class="col-md-8">
								...
								<div class="col-md-8 col-xs-8">
								 ...
								 <p style="padding-top:10px"><strong>Name:</strong> <?php echo $movie->firstname.'&nbsp;'. $movie->lastname.'&nbsp;('.$movie->yourpropesinal.')'; ?></p>
								  <p><strong>Current City: </strong><?php echo $movie->address;?></p>
								
								 <?php if($this->session->userdata('UNIQUEID')==$movie->property_unique_id){ ?><?php }else{ ?>
								 </div><div class="col-md-4 col-xs-4">
								   <a style="cursor:pointer;" class="btn btn-primary mydbubttt" data-toggle="modal" data-target="#myModal<?php echo $i; ?>">Interested..<br /> Contact Me!</a><?php } ?></div></div>
