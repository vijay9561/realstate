...
<div class="navigation">
	...
	<div class="container">
		<!--logo-->
			<div class="logo">
				<h1><a href="<?php echo site_url(); ?>">SAI BROKING</a></h1>
		...
		<div class="top-nav">
			...
			<li><div class="login123">
										<form method="post" enctype="multipart/form-data" id="searchallproperty" name="searchallproperty">
									<input type="text"  placeholder="Enter Location" id="alllocationhomennn" name="alllocationhomennn" required>
				...
				<li><span ><i class="glyphicon glyphicon-phone"> </i>+91 9370 977 391</span></li>
				<?php if($this->session->userdata('UID')){ ?>
				<li><a  href="<?php echo site_url(); ?>post-property" class="btn btn-danger"><i class="glyphicon glyphicon-briefcase"> </i> Post Property</a></li>
 ...
 <i class="glyphicon glyphicon-user"> </i>Hi <?php echo substr($this->session->userdata('NAME'),0,10); ?><i class="fa fa-caret-down" aria-hidden="true"></i></a>
  <ul class="dropdown-menu">
	...
	<li><a style="color: #2a2727;" href="<?php echo site_url();?>users-posted-prorperty">Your Property List</a></li>
				...
				<?php }else{ ?>
					<li><a  href="<?php echo site_url(); ?>login-property" class="btn btn-danger"><i class="glyphicon glyphicon-briefcase"> </i>Post Free Ads</a></li>
