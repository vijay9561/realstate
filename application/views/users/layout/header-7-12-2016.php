	...
	<div class="container">
		...
		<div class="col-md-2">
           ...
           <form method="post">
							<div class="row">
							<div class="col-md-4">
							<select type="text" class="form-control customewidth" name="allsearchmaincategory" id="allsearchmaincategory" onchange="allsearchmaincategoryr()" placeholder="Select Main Category" style="margin-bottom: 10px;border: 1px solid #000;">
		  ...
		  <?php } ?>
						...
						<select type="text" class="form-control customewidth" name="allsearchsubcatories123"  id="allsearchsubcatories123" placeholder="Select SubCategory" onchange="allsearchsubcatoriesr();" style="margin-bottom: 10px;border: 1px solid #000;" >
		  ...
		  <span id="allsearchsubcatoriesr" style="color:red;"></span>
							...
							<div class="col-md-4">
							<select type="text" class="form-control" name="allsearchcity"  id="allsearchcity" placeholder="Select Locality" style="margin-bottom: 10px;border: 1px solid #000;">
		  ...
		  <?php } ?>
                     ...
                     <div class="input-group stylish-input-group" style="border: 1px solid #000;">
		...
		<!--//logo-->
		<div class="col-md-4" style="padding: 1.3em 0;">
		<div class="top-nav">
