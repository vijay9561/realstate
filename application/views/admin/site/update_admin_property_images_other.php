...
function propertypost(){
			...
			$("#loaderimages").show();
			$.ajax({   
				url: "<?php echo site_url(); ?>Admin_Controller/update_your_images_values",
				type: "POST",
				data : formData,
				async: true,
				cache: false,
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-home"></i>Update Propery Images</li>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>view-admin-property" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
      </ol>
      <?php if($this->session->userdata('insertsucess')==1) { ?>
      <div class="alert alert-success"> <strong>Success!</strong> Property Category Added Successfully.. </div>
      ...
      <div class="form-info">
        <form role="form" method="post"  enctype="multipart/form-data" id="proppetpostedd">
          ...
          <div class="row">
            ...
            <div class="col-md-3" align="left"> <img src="<?php echo base_url(); ?>assets/upload/property_image/<?php echo $rows->image_name; ?>" class="img-thumbnail" style="width:100%;height: 146px;"  id="emptyopenimages<?php echo $i; ?>" />
              ...
              <span style="color:red;" id="lblErrorinserted<?php echo $i; ?>"></span> <br />
            </div>
            <?php $i++; } ?>
            <?php
		for($i=$count;$i<8; $i++){ ?>
            <div class="col-md-3" align="left" style="float:left;"> <img src="<?php echo base_url(); ?>assets/images/noimages.png" class="img-thumbnail" style="width:100%;height:146px;"   id="notemptyopenimages<?php echo $i; ?>" />
              ...
              <span style="color:red;" id="lblError<?php echo $i; ?>"></span> <br />
            </div>
            <?php } ?>
            <br />
          </div>
