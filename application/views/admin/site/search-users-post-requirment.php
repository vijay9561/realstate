...
$(document).ready(function(){
  ...
  <div class="row">
	...
	<table id="example" class="table table-striped table-bordered" width="100%" ><thead><tr><th><span>#</span></th><th>Requirement ID</th><th>Title</th><th>Date</th><th style="width:30%">Action &nbsp;&nbsp;
	...
	<?php  date_default_timezone_set('Asia/Kolkata'); $dateObject = new DateTime($rows->date); ?>
	<td><?php echo $dateObject->format('d-F-Y h:i A'); ?></td>
