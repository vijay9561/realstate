...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"> Update Propery</h1>
      <ol class="breadcrumb">
        <li> <i class="fa fa-dashboard"></i> <a href="<?php echo site_url(); ?>admin">Dashboard</a> </li>
        <li class="active"> <i class="fa fa-home"></i>  Update Propery</li>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>view-admin-property" class="btn btn-primary">
...
<label>Amenities</label><span><strong> This Amenities Selected:</strong> <?php echo substr($viewdata[0]->amenities,0,100); ?></span>
<div class="checkbox">
