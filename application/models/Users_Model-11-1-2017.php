            ...
            <div class="footer">
			  ...
			  <tr>
			   <td class="content-block" style="float:left;">
				 ...
				 <a href="www.saibroking.com" target="_blank"><img src="http://saibroking.com/assets/images/sai-broking-logo-2.png" style="height:40px;"></a></span>
				 </td>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p<strong>Dear '.$mysql[0]->name.' <br>Thank you for showing your interest for the property '.$myquery[0]->property_title.'. your contact details have been sent to the advertiser. 
						They will contact you soon.</strong></p>
						 ...
						 <tbody>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                     <th>Property Name:&nbsp;&nbsp;</th><td>'.$myquery[0]->property_title.'</td>
                                    </tr>
									 <tr>
									...
									<tr>
                                     <th>Property Location:&nbsp;&nbsp;</th><td>'.$myquery[0]->address_details.'</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p><strong>Dear '.$myquery[0]->name.' <br> '.$mysql[0]->name.' shown interest in your project '.$myquery[0]->property_title.'.</strong></p>
              ...
              <tr>
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p><strong>Dear Admin <br> '.$mysql[0]->name.' is interested in '.$myquery[0]->property_title.' of '.$myquery[0]->property_owner_name.'</p>
						
                        <p>vijay jadhav is applied for php developer.</p>
						<hr style="border-bottom: 1px solid #581b56;">
                              ...
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
									...
									<tr>
                                     <th>Owner Property Location:&nbsp;&nbsp;</th><td>'.$myquery[0]->address_details.'</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
