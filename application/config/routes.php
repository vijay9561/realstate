...
$route['sitemap']='Users_Controller/sitemap';
$route['search_result']='Users_Controller/search_result';
/*admin section start*/

$route['admin']='Admin_Controller/admin';
$route['sai-admin-login']='Admin_Controller/login';
...
$route['sub_sub_category']='Admin_Controller/sub_sub_category';
$route['slider_images']='Admin_Controller/slider_images';
